...
public class Expr {
     ...
     * throw an IllegalArgumentException if the string does not contain a legal
     * expression.
     */
     ...
     * specified value. If the expression is undefined for the specified value
     * of x, then Double.NaN is returned.
     *
